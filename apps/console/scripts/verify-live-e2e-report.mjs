...
export const requiredMarkers = [
  ...
  "Live smoke step: dataset capture preserved provenance and redaction preview",
  "Live smoke step: experiment run produced a passing quality gate for the candidate",
  "Live smoke step: quality gate preview linked experiment evidence to promotion eligibility",
  "Live smoke step: deployment promotion preview required visible quality evidence",
  "Quality loop live smoke completed",
  "Live smoke step: incident acknowledge captured audit evidence and delivery attempts",
  "Live smoke step: incident resolve preserved resolution summary and audit timeline",
  "Live smoke step: notification probe exposed a visible delivery attempt",
  "Live smoke step: backup dry-run surfaced scope proof and validation state",
  "Live smoke step: restore dry-run blocked destructive recovery without exact confirmation",
  "Live smoke step: restore dry-run accepted scope-matched recovery after confirmation",
  "Enterprise ops live smoke completed",
  ...
  "Live smoke step: model gateway validation surfaced health budget fallback and blocked plaintext credentials",
  "Live smoke step: tool dry-run surfaced schema risk approval and audit context",
  "Live smoke step: secret validation and rotation preserved audit visibility without exposing values",
  "Gateway governance live smoke completed",
