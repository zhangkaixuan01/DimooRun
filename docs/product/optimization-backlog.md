...
| It cannot name a user role, job, decision, risk, and recovery path from `console-user-task-model.md`. | Not grounded in user work. |
...
| Trust docs | Data categories, purpose, retention, and disable behavior must be documented in `../trust-and-security.md` before telemetry is marketed. |
