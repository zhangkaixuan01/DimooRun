...
This document defines the minimum user experience acceptance criteria for DimooRun Console workflows. It turns the task model in `docs/CONSOLE_USER_TASK_MODEL.md` into testable product expectations.
