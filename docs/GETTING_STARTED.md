...
This guide explains the intended first successful runtime path. Some steps depend on environment verification that is still marked partial in [Production Readiness Scorecard](PRODUCTION_READINESS_SCORECARD.md).
...
- Readiness: [Production Readiness Scorecard](PRODUCTION_READINESS_SCORECARD.md)
- Workflow coverage: [Product Workflow Coverage Matrix](PRODUCT_WORKFLOW_COVERAGE_MATRIX.md)
- UX acceptance: [Console Experience Acceptance](CONSOLE_EXPERIENCE_ACCEPTANCE.md)
