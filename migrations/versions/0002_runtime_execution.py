...
def upgrade() -> None:
    op.create_table(
        ...
        Column("service_account_id", BigInteger, ForeignKey("service_accounts.id")),
    ...
    op.create_table(
        ...
        Column("deployment_id", BigInteger, ForeignKey("deployments.id")),
        Column("session_id", BigInteger, ForeignKey("sessions.id")),
