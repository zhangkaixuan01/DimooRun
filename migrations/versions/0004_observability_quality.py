...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        *tenant_project_columns(),
        Column("run_id", BigInteger, ForeignKey("runs.id"), nullable=False),
        Column("source_node_id", BigInteger, ForeignKey("run_graph_nodes.id"), nullable=False),
        Column("target_node_id", BigInteger, ForeignKey("run_graph_nodes.id"), nullable=False),
    ...
    op.create_table(
        ...
        id_column(),
        *tenant_project_columns(),
        Column("dataset_id", BigInteger, ForeignKey("datasets.id"), nullable=False),
        Column("source_run_id", BigInteger, ForeignKey("runs.id")),
    ...
    op.create_table(
        ...
        *tenant_project_columns(),
        ...
        Column("baseline_agent_version_id", BigInteger, ForeignKey("agent_versions.id")),
        Column(
    ...
    op.create_table(
        ...
        id_column(),
        *tenant_project_columns(),
        Column("experiment_id", BigInteger, ForeignKey("experiments.id"), nullable=False),
    ...
    op.create_table(
        ...
        *tenant_project_columns(),
        ...
        Column("embedding_gateway_id", BigInteger, ForeignKey("model_gateways.id")),
